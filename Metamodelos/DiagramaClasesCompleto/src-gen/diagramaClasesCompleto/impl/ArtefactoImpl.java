 ...
 *   <li>{@link diagramaClasesCompleto.impl.ArtefactoImpl#getArtefactoId <em>Artefacto Id</em>}</li>
...
public class ArtefactoImpl extends MinimalEObjectImpl.Container implements Artefacto {
	...
	/**
	 * The default value of the '{@link #getArtefactoId() <em>Artefacto Id</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getArtefactoId()
	 * @generated
	 * @ordered
	 */
	protected static final String ARTEFACTO_ID_EDEFAULT = "demo";

	/**
	 * The cached value of the '{@link #getArtefactoId() <em>Artefacto Id</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getArtefactoId()
	 * @generated
	 * @ordered
	 */
	protected String artefactoId = ARTEFACTO_ID_EDEFAULT;
	 ...
	 */
	@Override
	public void setArtefactoId(String newArtefactoId) {
		String oldArtefactoId = artefactoId;
		artefactoId = newArtefactoId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramaClasesCompletoPackage.ARTEFACTO__ARTEFACTO_ID,
					oldArtefactoId, artefactoId));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case DiagramaClasesCompletoPackage.ARTEFACTO__GRUPO_ID:
			return getGrupoId();
		case DiagramaClasesCompletoPackage.ARTEFACTO__ARTEFACTO_ID:
			return getArtefactoId();
	...
	public void eSet(int featureID, Object newValue) {
		...
		case DiagramaClasesCompletoPackage.ARTEFACTO__GRUPO_ID:
			...
			return;
		case DiagramaClasesCompletoPackage.ARTEFACTO__ARTEFACTO_ID:
			setArtefactoId((String) newValue);
			return;
		case DiagramaClasesCompletoPackage.ARTEFACTO__DESCRIPCION:
	...
	public void eUnset(int featureID) {
		...
		case DiagramaClasesCompletoPackage.ARTEFACTO__GRUPO_ID:
			...
			return;
		case DiagramaClasesCompletoPackage.ARTEFACTO__ARTEFACTO_ID:
			setArtefactoId(ARTEFACTO_ID_EDEFAULT);
			return;
		case DiagramaClasesCompletoPackage.ARTEFACTO__DESCRIPCION:
	...
	public boolean eIsSet(int featureID) {
		...
		case DiagramaClasesCompletoPackage.ARTEFACTO__ARTEFACTO_ID:
			return ARTEFACTO_ID_EDEFAULT == null ? artefactoId != null : !ARTEFACTO_ID_EDEFAULT.equals(artefactoId);
		case DiagramaClasesCompletoPackage.ARTEFACTO__DESCRIPCION:
