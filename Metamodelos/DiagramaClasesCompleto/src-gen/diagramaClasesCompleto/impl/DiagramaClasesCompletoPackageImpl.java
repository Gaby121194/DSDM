...
public class DiagramaClasesCompletoPackageImpl extends EPackageImpl implements DiagramaClasesCompletoPackage {
	 ...
	 */
	@Override
	public EAttribute getRelacion_Dependiente() {
	 ...
	 */
	@Override
	public EAttribute getArtefacto_ArtefactoId() {
	...
	public void createPackageContents() {
		...
		createEAttribute(relacionEClass, RELACION__DEPENDIENTE);
		...
		createEAttribute(artefactoEClass, ARTEFACTO__ARTEFACTO_ID);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getRelacion_TipoABM(), this.getTipoABM(), "tipoABM", "sinRepresentacion", 0, 1, Relacion.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getRelacion_Dependiente(), ecorePackage.getEBoolean(), "dependiente", null, 0, 1, Relacion.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getArtefacto_GrupoId(), ecorePackage.getEString(), "grupoId", "com.example", 0, 1,
				...
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getArtefacto_ArtefactoId(), ecorePackage.getEString(), "artefactoId", "demo", 0, 1,
				Artefacto.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
