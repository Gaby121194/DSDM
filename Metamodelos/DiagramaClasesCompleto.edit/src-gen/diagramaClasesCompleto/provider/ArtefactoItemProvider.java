...
public class ArtefactoItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addArtefactoIdPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Artefacto Id feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addArtefactoIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Artefacto_artefactoId_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Artefacto_artefactoId_feature",
								"_UI_Artefacto_type"),
						DiagramaClasesCompletoPackage.Literals.ARTEFACTO__ARTEFACTO_ID, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
